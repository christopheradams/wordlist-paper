...
wordlist = Mnemonic('chinese_traditional').wordlist
...
def main():
    if len(sys.argv) == 1:
        doit(fname='wordlist-chinese.pdf', numbering_type='hex')
    elif sys.argv[1] == "--decimal" or sys.argv[1] == "-d":
        doit(fname='wordlist-decimal-chinese.pdf', numbering_type='decimal')
    else:
